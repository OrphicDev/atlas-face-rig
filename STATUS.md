STATUS: **F0 INCOMPLÈTE** — 200 sondes, 193 réussies, 3 échec(s), 4 sautée(s)

> Vérité unique : [`reports/f0-final/RAPPORT_F0_FINAL.md`](reports/f0-final/RAPPORT_F0_FINAL.md).
> Mesuré le 2026-08-16, commit `f6f1c86`, Blender 5.1.2.
...
| sondes | **193 / 200**, comptées par registre et jamais à la main |
| suites en échec | aucune |
| F1 | **ne commence pas** tant que le gate n'est pas passé |

## Ce qui bloque, nommément

- clignement gauche sur la cage : 0.19455 mm pour 0,20 exigés
