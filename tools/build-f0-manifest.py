...
LIVRABLES = [
    ...
    "reports/f0-final/replay-determinisme.json",
    "reports/f0-final/report-links.json",
    "reports/f0-final/living-docs.json",
    "reports/f0-final/body-banc-synthetique.json",
    "reports/f0-final/body-surface-deform.json",
    "reports/f0-final/body-replacement.json",
    "reports/f0-final/body-replacement-plan.json",
    "reports/f0-final/body-methodes-ab.json",
    "reports/f0-final/RAPPORT_F0_FINAL.md",
    "reports/f0-final/RAPPORT_F0_FINAL.valeurs.json",
